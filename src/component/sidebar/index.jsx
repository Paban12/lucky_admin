        ...
        <div className="nav-wrapper mb-[36px] pr-[50px]">
          <div className="item-wrapper mb-5">
            ...
            >
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/userTransaction" ? "nav-active" : ""
                  } `}
              >
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/withdrawalList" ? "nav-active" : ""
                  } `}
              >
                <Link to="/withdrawalList">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
